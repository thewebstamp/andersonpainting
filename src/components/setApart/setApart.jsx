    ...
    return (
        <div className="set-apart-wrap">
            <div className="sa-top" ref={setApartT}>
                <div className="sa-headline">WHY CHOOSE ANDERSON PAINTING?</div>
                <h2>We are a Trusted Name in the Painting Industry</h2>
            ...
            <div className="sa-base" ref={setApartB}>
                ...
                <img src={Images.deck} className="sa-img" />
                <img src={Images.deck} className="sa-img-height" />
            </div>
        </div>
    )
}
