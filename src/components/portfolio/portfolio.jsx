...
function Portfolio() {
    ...
    const [portfolio, setPortfolio] = useState([
        ...
        Images.p10, Images.p11, Images.p12, Images.p13, Images.p14, Images.p15, Images.p16, Images.p17, Images.p18, Images.p19, Images.p20
    ]);
    ...
    return (
        <div className="portfolio-comp" id='portfolio' ref={portfolioA}>
            ...
            <h2>Latest Completed Projects of Anderson Painting</h2>
