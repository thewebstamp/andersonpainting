    ...
    return (
        <div className="about-comp">
            ...
            <div className="about-comp-text" ref={aboutB}>
                <div className="a-headline">ABOUT ANDERSON PAINTING</div>
                <h2>We Deliver High-Quality Painting Services With Integrity</h2>
                <p>At Anderson Painting, we bring over {new Date().getFullYear() - 2000} years of experience to every project, delivering high-quality painting solutions for residential, commercial, and healthcare environments. We approach every project with care and expertise.</p>
