    ...
    const testimonial = [
        {
            name: 'SARAH W',
            address: 'Louisville',
            review: "Anderson Painting transformed our home beyond our expectations. The team was professional, skilled, and attentive to every detail. Can't recommend them enough"
        },
        {
            name: 'Emily R',
            address: 'St Matthews',
            review: 'Anderson Painting in collaboration with a joinery company turned our outdated kitchen into a modern masterpiece. Their attention to detail and professionalism were outstanding'
        },
        {
            name: 'John S',
            address: 'Shively',
            review: 'Anderson Painting have done a wealth of work for me at very competitive prices. Reliability and honesty not in question and work is of very good standard 👍 I have no hesitation in recommending'
        }
    ];
    ...
    return (
        <div className="testimonial-comp">
            ...
            <div className="t-base" ref={testimonialB}>
                ...
                <h2>What Customers Say About Anderson Painting</h2>
